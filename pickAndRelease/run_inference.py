...
from env import set_env_Inference
...
agent.load("/fail-detect_acss/runs/Isaac-Lift-Franka-v3/25-09-24_07-52-59-814613_PPO(above_bin)/checkpoints/best_agent.pt")
